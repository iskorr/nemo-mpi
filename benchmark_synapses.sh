...
./random output_synapse/rand.txt -n 2000 -m 10000
...
mpirun -np 2 ./mpi_dist_general 2000 10000 0 500 1 0 output_synapse/mpi1.txt
mpirun -np 3 ./mpi_dist_general 2000 10000 0 500 1 0 output_synapse/mpi2.txt
mpirun -np 4 ./mpi_dist_general 2000 10000 0 500 1 0 output_synapse/mpi3.txt
mpirun -np 5 ./mpi_dist_general 2000 10000 0 500 1 0 output_synapse/mpi4.txt
mpirun -np 6 ./mpi_dist_general 2000 10000 0 500 1 0 output_synapse/mpi5.txt
